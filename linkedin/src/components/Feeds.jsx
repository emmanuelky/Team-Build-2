...
const Feeds = () => {
  ...
  const upload = async () => {
    ...
    try {
      const { data } = await axios.post(linkString, formData, {
        headers: {
  ...
  return (
    <>
      <div
        onClick={handleShow}
        className="d-flex border bg-white mx-3 ml-4 mb-3"
        style={{ borderRadius: "12px", border: "1px" }}
      >
            ...
            <div className="d-flex">
              ...
              <div className="mr-2 align-self-center">
                <Button
                  ...
                  className="rounded-pill border text-left text-muted"
                  size="lg"
                  style={{ width: "438px" }}
                >
                  <strong>
                    <span style={{ fontSize: "14px" }}>Start a post</span>
                  </strong>{" "}
                </Button>
              </div>
            </div>
            <div
              className="mt-3 d-flex text-muted"
              style={{ fontSize: "18px" }}
            >
        ...
        posts
          ...
          .map((post) => (
            <>
              <div
                key={post.user._id}
                className="d-flex justify-content-between border bg-white mx-3 ml-4 mb-2"
                style={{ borderRadius: "12px", border: "1px" }}
              >
                <div className="mt-3 mx-3">
                  <div className="d-flex">
                    ...
                    <div className=" ml-2 d-flex flex-column text-left mb-3">
                      ...
                      >
                        <span
                          className="my-3 flex-wrap  text-muted t"
                          style={{ fontSize: "13px" }}
                        >
                          {post.text}{" "}
                        </span>
                      ...
                      <div
                        className="mt-3 d-flex text-muted border-top"
                        style={{ fontSize: "18px" }}
                      >
                        <div className="m-2">
          ...
          <div className="d-flex flex-column">
            ...
            <div className="d-flex">
              ...
              <div className="align-self-center text-center">
                <Button
                  variant="outline-light secondary"
                  className="rounded-pill border text-center text-muted "
                  size="sm"
                  style={{ width: "200px" }}
                >
                  <strong>
                    ...
                    >
                      ...
                      <span style={{ fontSize: "14px" }} className="mx-4">
                        Tarun
                      </span>
                      <i class="fas fa-caret-down mx-5"></i>{" "}
                    </div>
                  </strong>{" "}
                </Button>
              </div>
                ...
                >
                  <strong>
                    <div
                      ...
                      style={{ fontSize: "14px" }}
                    >
                      <i class="fas fa-globe-africa mx-1"></i>
            ...
            <div className="d-flex flex-column ">
              <div className="text-left ml-3">
                <div>
                  <a href="">
                    <strong>Add Hashtags</strong>{" "}
                  </a>
                </div>
              </div>
              <div
                className="d-flex m-2 mx-1 text-muted "
                style={{ fontSize: "25px" }}
              >
                <div className="m-2">
