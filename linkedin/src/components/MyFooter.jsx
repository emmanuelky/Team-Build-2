      ...
      <Row>
        ...
        <Col xs={12} sm={6} lg={2} className="p-0">
          <Button className="text-muted" variant="link">
            ...
            Questions? <br />
            <span className="Questions">Visit our help center</span>
          </Button>
          <Button className="text-muted" variant="link">
            ...
            <span className="Manage"> Go to your settings</span>
          </Button>
        </Col>
        <Col xs={12} lg={4} className="dropup-language p-0">
          Select Language
          <DropdownButton title="English (English)" variant="link" drop="down">
        ...
        <Col xs={12} className="p-0 copyright">
          <Button className="copyright text-left text-muted" variant="link">
